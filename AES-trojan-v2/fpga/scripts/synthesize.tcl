...
## Target: CW312-A35 (XC7A35T-1CSG324) on CW313 carrier board
##
## Usage:
...
set cw_dir     [file join $fpga_root "rtl" "cw"]
set xdc_file   [file join $fpga_root "constraints" "cw312_a35.xdc"]
set output_dir [file join $fpga_root "build"]

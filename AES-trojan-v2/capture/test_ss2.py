...
def main():
    parser = argparse.ArgumentParser(description="Test CW312T-A35 SS2 communication")
    parser.add_argument("--bitstream", default=None,
                        help="Path to bitstream (default: ../fpga/build/ss2_aes_wrapper.bit)")
    ...
    bitstream = args.bitstream or __import__('os').path.join(script_dir, "..", "fpga", "build", "ss2_aes_wrapper.bit")
    ...
    # =========================================================================
    print(f"\n[3] Programming FPGA with SS2 AES bitstream: {bitstream}")
